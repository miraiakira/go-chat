  ...
  return (
    <div className="my-8 px-4 md:mx-32 w-full h-full">
      <div className="flex justify-center mt-3 p-5">
        <input
          type="text"
          className="p-2 rounded-md border-grey focus:outline-none focus:border-blue"
          placeholder="room name"
          value={roomName}
          onChange={(e) => setRoomName(e.target.value)}
        />
        <button
          className="rounded-md bg-blue-600 font-bold border text-white p-2 md:ml-4"
      ...
      <div className="mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mt-5">
          {rooms.map((room, index) => (
            <div
              key={index}
              className="border border-blue-600 p-4 flex items-center rounded-md w-full"
            >
              ...
              <div className="">
                <button
                  className="px-4 text-white bg-blue-600 rounded-md"
